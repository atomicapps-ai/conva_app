...
/**
 * Email allowed to see the hosted operator dashboard's link in Settings →
 ...
 * after clicking it.
 */
const OPERATOR_EMAILS = new Set(["getconva@gmail.com"]);

/** Is this signed-in email allowed to see the Admin link? */
