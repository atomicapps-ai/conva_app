...
/**
 * Floating controls for a live Context rehearsal, shown over the cockpit while
    ...
    <div className="pointer-events-none fixed inset-x-0 bottom-3 z-40 flex justify-center px-3">
      <div className="glass-raised pointer-events-auto flex max-w-full items-center gap-3 rounded-full border border-border-strong px-3 py-1.5 shadow-[var(--shadow-lg)]">
        ...
        <button
          ...
          disabled={!suggestion}
          onClick={() =>
            suggestion && void backend.context.rehearsalSay(suggestion.text)
          }
          title={
            suggestion
        ...
        <button
          type="button"
          onClick={() => void backend.context.rehearsalYourTurn()}
