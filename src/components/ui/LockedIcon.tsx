...
// Owner-supplied geometry, committed 2026-09-08 in 0e94d97 and restored after
// the legacy web mark accidentally replaced it in 533e9c4. Keep this string
// byte-for-byte equal to src/assets/brand/conva-mark-cutout-white.svg; the
// regression test fails if the dashboard badge and file-backed logos drift.
const MARK_D =
  "M500.89,337.75l-3.98-173.83-113.4-130.07L211.51,6.52,62.42,96.16,5.82,260.73l62.59,162.88,152.52,83.64,169.2-32.97,103.17,8.53-38.91-82.27,46.5-62.79ZM344.86,397.61l-109.11,21.3-98.58-54.08-41.16-104.25,36.38-105.87,96.26-58.78,111.59,18.27,73.15,83.76-48.4,21.88-2.64-.76-46.97-56.24-73.16-12.91.03,50.01-66.14-12-24.82,67.56,25.57,72.02,62.77,35.67,75.75-12.17,47.88-56.86,52.06,14.62-70.46,88.83Z";
...
const MARK_SILHOUETTE_D =
  "M500.89,337.75l-3.98-173.83-113.4-130.07L211.51,6.52,62.42,96.16,5.82,260.73l62.59,162.88,152.52,83.64,169.2-32.97,103.17,8.53-38.91-82.27,46.5-62.79Z";
